...
namespace Litium.Accelerator.Search.Filtering
{
    ...
    public class FilterService
    {
        ...
        {
            var filters = _requestModelAccessor.RequestModel.WebsiteModel.Fields.GetValue<IList<string>>(AcceleratorWebsiteFieldNameConstants.FiltersIndexedBySearchEngines);
