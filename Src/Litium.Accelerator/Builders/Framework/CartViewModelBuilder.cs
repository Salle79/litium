...
namespace Litium.Accelerator.Builders.Framework
{
    public class CartViewModelBuilder : IViewModelBuilder<CartViewModel>
    {
        ...
        public CartViewModel Build(Cart cart)
        {
            ...
            var checkoutPage = _requestModelAccessor.RequestModel.WebsiteModel.Fields.GetValue<PointerPageItem>(AcceleratorWebsiteFieldNameConstants.CheckouPage).MapTo<LinkModel>();
