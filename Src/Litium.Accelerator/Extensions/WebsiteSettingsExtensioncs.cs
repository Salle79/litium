...
namespace Litium.Accelerator.Extensions
{
    ...
    public static class WebsiteSettingsExtension
    {
        ...
        {
            return websiteModel.Fields.GetValue<bool>(AcceleratorWebsiteFieldNameConstants.InFirstLevelCategories);
        }
        ...
        {
            return websiteModel.Fields.GetValue<bool>(AcceleratorWebsiteFieldNameConstants.InArticlePages);
        }
        ...
        {
            return websiteModel.Fields.GetValue<bool>(AcceleratorWebsiteFieldNameConstants.InBrandPages);
        }
        ...
        {
            return websiteModel.Fields.GetValue<bool>(AcceleratorWebsiteFieldNameConstants.InProductListPages);
        }
