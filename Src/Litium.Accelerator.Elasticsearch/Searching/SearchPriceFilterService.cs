...
namespace Litium.Accelerator.Searching
{
    ...
    internal class SearchPriceFilterService
    {
        ...
        public IEnumerable<Func<QueryContainerDescriptor<ProductDocument>, QueryContainer>> GetPriceFilterTags(SearchQuery searchQuery, Container container, Guid countrySystemId)
        {
