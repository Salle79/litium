...
namespace Litium.Accelerator.WebForm.Site.Administration.Settings
{
    internal class SettingsPageSetup : IStartupTask, IAppExtension
    {
        void IStartupTask.Start()
        {
            ...
            pages.Add(new ControlPanelPage("~/Litium/UI/settings/iframe/%2FLitium%2FappSettings%2Faccelerator%2Findexing", "AcceleratorIndexingSetting", ControlPanelPagePermission.All)
            {
            ...
            pages.Add(new ControlPanelPage("~/Litium/UI/settings/iframe/%2FLitium%2FappSettings%2Faccelerator%2Ffilter", "AcceleratorFilterSetting", ControlPanelPagePermission.All)
            {
                //AuthorizeFunc = () => FoundationContext.Current.User.HasModulePermission(ModuleCMS.Instance.ID, BuiltInModulePermissionTypes.PERMISSION_ID_ALL, true, true)
            }); 
            ...
            {
                pages.Add(new ControlPanelPage("~/Litium/UI/settings/iframe/%2FLitium%2FappSettings%2Faccelerator%2Fsearchindexing", "AcceleratorSearchIndexingSetting", ControlPanelPagePermission.All));
            }
        }
