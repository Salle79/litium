...
namespace Litium.Accelerator.Mvc.Definitions
{
    ...
    public class FieldTemplateSetupDecorator : FieldTemplateSetup
    {
        ...
        private readonly IDictionary<(Type areaType, string id), (Type controllerType, string action)> _controllerMapping = new Dictionary<(Type areaType, string id), (Type controllerType, string action)>
        {
            ...
            [(typeof(Websites.WebsiteArea), PageTemplateNameConstants.Station)] = (typeof(Controllers.Station.StationController), nameof(Controllers.Station.StationController.Station)),
            ...
            [(typeof(Websites.WebsiteArea), PageTemplateNameConstants.StationList)] = (typeof(Controllers.Station.StationController), nameof(Controllers.Station.StationController.StationList)),
