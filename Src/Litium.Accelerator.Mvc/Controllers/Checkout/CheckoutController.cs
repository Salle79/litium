...
namespace Litium.Accelerator.Mvc.Controllers.Checkout
{
    public class CheckoutController : ControllerBase
    {
        ...
        {
            var checkoutPageUrl = _requestModelAccessor.RequestModel.WebsiteModel.Fields.GetValue<PointerPageItem>(AcceleratorWebsiteFieldNameConstants.CheckouPage).MapTo<LinkModel>()?.Href;
