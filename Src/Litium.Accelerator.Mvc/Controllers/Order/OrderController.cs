...
namespace Litium.Accelerator.Mvc.Controllers.Order
{
    public class OrderController : ControllerBase
    {
        ...
        [HttpGet]
        public ActionResult Order(string id, bool print = false)
        {
        ...
        public ActionResult ApproveOrder(string id, bool isOrderPage = false, int page = 1, bool showMyOrders = false)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult CancelOrder(string id, bool isOrderPage = false, int page = 1, bool showMyOrders = false)
        {
            if (!string.IsNullOrWhiteSpace(id))
            {
